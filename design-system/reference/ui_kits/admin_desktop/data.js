window.MSL_DATA = (function () {
  ...
  ].map(([id, fi, ti, ci, price, date, si]) => ({
    id, from: city[fi], to: to[ti], cargo: cargo[ci], weight: '51,360 kg. 4 ml',
    price, date, status: statuses[si][0], tone: statuses[si][1],
  }));

  const carriers = ['Arkas Logistics', 'Zim Integrated', 'HMM Shipping', 'MSC Cargo', 'CMA CGM Group', 'ONE Network', 'Maersk Line', 'Cosco Freight', 'Hapag Bridge']
    .map((name, i) => ({
      rank: i + 1, name, location: 'Belfast, United Kingdom',
  ...
  ].map(([name, type, count, created, on], i) => ({ id: 'a' + i, name, type, count, created, on }));

  const chats = [
    { id: 'c1', name: 'Harrold Tafoya', role: 'Carrier', typing: true, time: '05:11 PM', pinned: true },
    { id: 'c2', name: 'Mate Bruney', role: 'Carrier', preview: 'Thank you. Glad to feel this …', time: '04:17 PM', unread: 4, pinned: true },
    { id: 'c3', name: 'Shannon Kile', role: 'Driver', preview: 'Yes, thank you…', time: '16:01 PM', unread: 2, pinned: true },
    { id: 'c4', name: 'Kynie Mccotter', role: 'Carrier', preview: 'Have you had a chance to check it out?', time: '03:29 PM', unread: 3 },
    { id: 'c5', name: 'Savina Navarrate', role: 'Carrier', preview: "I'm already at the warehouse and…", time: '02:11 PM', unread: 1 },
    { id: 'c6', name: 'Marcel Pasculli', role: 'Driver', preview: 'Could you send me an updated invoice?', time: 'Yesterday' },
    { id: 'c7', name: 'Gilbertine Rivet', role: 'Driver', preview: 'Yes, I am. I will let you know…', time: 'Yesterday' },
    { id: 'c8', name: 'Nisa Cordial', role: 'Driver', preview: 'Yes, thank you…', time: 'Yesterday' },
    { id: 'c9', name: 'Rafi Rohamat', role: 'Carrier', preview: "I'm already at the warehouse and…", time: 'Dec 20, 2024' },
    { id: 'c10', name: 'Wenston Covil', role: 'Driver', preview: 'Can I fill up here? Location', time: 'Dec 18, 2024' },
    { id: 'c11', name: 'Albert Flores', role: 'Driver', preview: 'Yes, thank you…', time: 'Dec 12, 2024' },
  ];

  const thread = [
    { own: true, time: '09:44 PM', read: true, text: 'Sounds perfect. I will drop a message to Nick regarding changes.' },
    { own: true, quote: { author: 'Mate Bruney', text: 'Wa he insist on this date?' }, text: "I'm afraid, yes, he wille" },
    { own: false, author: 'Harrold Tafoya', time: '09:44 PM', text: 'Nick, payday is coming. Can you copy the invoice for our bookkeeping department?' },
    { own: true, time: '10:50 PM', read: true, text: "I'm attaching the invoice for the last shipment. Please check it out and assure of correctness." },
    { own: true, attachment: { name: "I'm Invoice Ceva Bahn 21032023", kind: 'PDF' } },
    { own: false, author: 'Harrold Tafoya', time: '09:44 PM', text: 'Thank youl Glad to feel this deference' },
  ];
  ...
  return { orders, carriers, automations, chats, thread, revenueCurrent, revenuePrevious,
    monthLabels, orderBars, fleet, kpis, nav, titles };
})();
